        ...
        return {
            ...
            link: function postLink(scope, element, attrs) {
                ...
                function setNavigationOnArrows() {
                    console.log("navigation on arrows start");
                    ...
                    console.log("navigation on arrows end");
                }
                ...
                function prepareHeader(header) {
                    console.log("prepare header start");
                ...
                function prepareHeaderControls() {
                    ...
                    console.log("prepare header controls end");
                }
                ...
                function drawTable(source) {
                    ...
                    console.log("before prepare header");
                    if (headerTitlesAttr) {
                    ...
                    console.log("after prepare header");

                    //get the property values for rows
                    console.log("before prepare rows");
                    ...
                    console.log("before call dataTables");                    
                    ...
                    console.log("after call dataTables");

                    decorateDataTableOnChange();

                    setNavigationOnArrows();

                    console.log("draw table end");
                }
